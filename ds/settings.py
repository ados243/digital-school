...
# Temporaire : 2FA coupée en dur. Coolify MFA_WHATSAPP=1 écrasait le défaut 0.
MFA_WHATSAPP_ACTIF = False
INSCRIPTION_WHATSAPP_ACTIF = False
...
# App Secret Meta (optionnel) : requis si l'app force appsecret_proof
WHATSAPP_META_APP_SECRET = (
    os.environ.get("WHATSAPP_META_APP_SECRET", "") or ""
).strip()
